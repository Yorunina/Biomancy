	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		tag(ModBlockTags.DECAY_DESTRUCTIBLE)
				.add(
						...
						ModBlocks.FIBROUS_PRIMAL_FLESH.get(),
						ModBlocks.FIBROUS_PRIMAL_FLESH_SLAB.get(),
						ModBlocks.FIBROUS_PRIMAL_FLESH_STAIRS.get(),
						ModBlocks.FIBROUS_PRIMAL_FLESH_WALL.get(),
