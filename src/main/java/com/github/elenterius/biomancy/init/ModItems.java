...
public final class ModItems {
	...
	public static final RegistryObject<BioluminescentGooItem> BIO_LUMENS = registerItem("bio_lumens", BioluminescentGooItem::new);
	...
	public static final RegistryObject<ImpalerItem> IMPALER = registerItem("impaler", props -> new ImpalerItem(200, props.stacksTo(1).rarity(ModRarities.ULTRA_RARE)));
	...
	public static final RegistryObject<SimpleBlockItem> ONEWAY_MEMBRANE = registerSimpleBlockItem(ModBlocks.ONEWAY_MEMBRANE);
